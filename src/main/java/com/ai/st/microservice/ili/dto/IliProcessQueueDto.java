...
public class IliProcessQueueDto implements Serializable {
    ...
    private Ili2pgImportSinicDto importSinicDto;
    ...
    public Ili2pgImportSinicDto getImportSinicDto() {
        return importSinicDto;
    }

    public void setImportSinicDto(Ili2pgImportSinicDto importSinicDto) {
